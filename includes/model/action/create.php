...
<?php
    ...
    add_action('wp_ajax_AddNewAgents', 'AddNewAgents');
    add_action('wp_ajax_nopriv_AddNewAgents', 'AddNewAgents');
    function AddNewAgents() 
    { 
        if( !isset($_POST['cluster_name']) || !isset($_POST['cluster_info']) || !isset($_POST['cluster_hostname']) || !isset($_POST['cluster_capacity']) || !isset($_POST['mcafee_ready']) )
        {
            echo json_encode( 
                array(
                    'status'=>'danger',
